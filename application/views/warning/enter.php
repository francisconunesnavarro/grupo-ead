                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="main-error mb-xlg">
                            <h2 class="error-code text-dark text-center text-semibold m-none"><i class="fa fa-close"></i> Erro</h2>
                            </br>
                            <p class="error-explanation text-center">É preciso estar logado para continuar.</p>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <h4 class="text">Faça o login, e clique no link novamente:</h4>
                        <ul class="nav nav-list primary">
                            <li><a style="font-size: 15pt" href="<?= $this->config->base_url('home/login') ?>"><i class="fa fa-caret-right text-dark"></i> Login do EAD</a></li>
                        </ul>
                    </div>
                </div>
            </div>
